...
void main() {
  test(
    'older app fails closed without downgrading a newer Vault schema',
    () async {
      ...
      final executor = NativeDatabase.memory(
        setup: (sqlite) {
          rawDatabase = sqlite;
          sqlite.execute(
            'CREATE TABLE rollback_sentinel (value TEXT NOT NULL)',
          );
          sqlite.execute(
            "INSERT INTO rollback_sentinel (value) VALUES ('preserve-me')",
          );
      ...
      final sentinelRows = rawDatabase.select(
