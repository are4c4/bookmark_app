...
## Current checkpoint — 2026-09-07 02:10 JST
...
Latest audited `main`: `340215ef530d00c577eb2fe3e5fca501d646773b` after Object `#442 Add safe canonical Image detail edit actions`; Refactor `#443` is also merged in current main history and is maintainability-only.
...
- `#442` adds Image detail edit controls that route only through `CanonicalImageEditService.edit/restoreOriginal`; it changes Image bytes/geometry under Object-owned safety policy but does not create, mutate, detach or retarget Relations, does not alter Photo mappings, and does not bypass canonical Relation APIs.
