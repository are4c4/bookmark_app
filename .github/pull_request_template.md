...
- [ ] `bash tool/check_full.sh` (or explain why local Flutter execution is unavailable)
- [ ] GitHub Flutter CI
...
- [ ] Active lane progress file updated when this changes durable lane state/ownership.
- Cross-lane dependency or next action: 
