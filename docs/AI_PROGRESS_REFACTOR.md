...
#1079 established the durable source-of-truth split: repository handoffs record stable contracts/resume guidance, while live GitHub owns open PRs, CI, branch tips, repository settings and current ownership. #1079 itself is not an active work queue; future documentation-drift work starts from a new live focused Issue while preserving this policy.
