...
enum BookmarkStage1Property { image, url, tags, people, description, createdAt, favorite }
          ...
          rows: bookmarks.map((bookmark) {
            return DataRow(
              ...
              cells: [
                ...
                DataCell(Text(bookmark.people.map((person) => person.name).join(', '))),
