...
void main() {
  testWidgets('real page saves Relation through canonical editor path',
      (tester) async {
    ...
    final authorProperty = bookType.properties.singleWhere(
    ...
    expect(
      ObjectRelationValue.fromJson(updated.values[authorProperty.id]).objectIds,
      <int>[aliceId],
    );
  });
}
