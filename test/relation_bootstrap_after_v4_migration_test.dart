...
void main() {
  test('canonical Relation facade bootstraps after v4 database migration', () async {
    ...
    await database.customStatement(
      "INSERT INTO workspaces(name) VALUES ('Relation v4 migration test')",
    );
    ...
    expect(legacyPeopleAfterRelationWrite.single.read<int>('bookmark_id'), 4);
    ...
    expect(legacyRelationsAfterRelationWrite.single.read<int>('source_bookmark_id'), 4);
    expect(
