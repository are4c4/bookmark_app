...
void main() {
  ...
  test('CAS accepts a semantically equal noncanonical historical snapshot', () async {
    ...
    expect((await setup.bodyStore.read(setup.objectId)).toJson(), next.toJson());
  });

  test('CAS rejects a stale semantic snapshot and preserves the newer Body', () async {
    final setup = await fixture();
    addTearDown(setup.database.close);
