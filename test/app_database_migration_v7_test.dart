...
void main() {
  test('v7 saved views migrate through v8-v16 with visible properties default', () async {
    final executor = NativeDatabase.memory(
      setup: (sqlite) {
        ...
        sqlite.execute(
          ...
          "VALUES (4, 'Legacy view', 'table', 'needle', 1)",
        );
    ...
    final view = await database.customSelect(
      'SELECT id, name, layout_type, search_query, favorites_only, visible_properties '
      'FROM saved_views WHERE id = 4',
    ).getSingle();
    ...
    expect(view.read<String>('visible_properties'), 'image,url,tags,favorite');
  });
}
