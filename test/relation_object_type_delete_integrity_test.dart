...
void main() {
  ...
  test('self Relation does not block deletion of its own ObjectType', () async {
    ...
    final tagTypeId = await store.createObjectType(workspaceId: workspaceId, name: 'Tag');
    await store.createRelationProperty(objectTypeId: tagTypeId, name: 'Parent', targetObjectTypeId: tagTypeId, multiple: false);
