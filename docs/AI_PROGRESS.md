...
- #1360 remains open for unchanged-source repeated-run variance evidence and later evidence-backed performance budget decisions; benchmark infrastructure and bounded large-run timeout are established prerequisites.
- #1511/#1532 are completed measurement checkpoints: healthy canonical Search prepare/open, query latency, and explicit rebuild/repair are measured as separate scenarios. Resume #1360 from repeated equivalent-source evidence, not by reimplementing #1511; optimization requires measured evidence.
